(ns metabase.task.send-customcron-pulses-test
  (:require [expectations :refer :all]
            ...
            [metabase.task.send-customcron-pulses :refer :all]
  ...
  (et/with-fake-inbox
    (let [exceptions (atom [])
      ...
      (et/with-expected-messages 1
        (#'metabase.task.send-customcron-pulses/send-customcron-pulses! (clj-time.core/now) on-error))
